...
import hlumeloImage from '../assets/team/hlumelo-madonono.jpg';
import onesimoImage from '../assets/team/onesimo-siloyi.jpg';
import visionlogo from '../assets/vision-logo.jpg';
import viweImage from '../assets/team/viwe-mtuna.jpg';
import thandoImage from '../assets/team/thandolwethu-siloyi.jpg';
import thabisoImage from '../assets/team/thabiso-matsaba.jpg';
...
const AboutSection = ({ theme }) => {
  const teamMembers = [
    {
      name: 'Hlumelo "RonnieSA" Madonono',
      role: 'DJ/Editor',
      imageSrc: hlumeloImage,
      imageHint: 'Photo of Hlumelo Madonono, DJ and Editor for KALYANO',
    },
    {
      name: 'Onesimo "Sir Onies" Siloyi',
      role: 'DJ/Editor',
      imageSrc: onesimoImage,
      imageHint: 'Photo of Onesimo Siloyi, DJ and Editor for KALYANO',
    },
    {
      name: 'Siphesihle "Vision" Ndayi',
      role: 'Production/Lead Video Editor',
      imageSrc: visionlogo,
      imageHint: 'Photo of Sihle, Lead Video Editor and Production for KALYANO',
    },
    {
      name: 'Viwe Mtuna',
      role: 'Communications Director',
      imageSrc: viweImage,
      imageHint: 'Photo of Viwe Mtuna, Communications Director for KALYANO',
    },
    {
      name: 'Thandolwethu Siloyi',
      role: 'Production/Lead Video Editor',
      imageSrc: thandoImage,
      imageHint: 'Photo of Thandolwethu Siloyi, Lead Video Editor and Production for KALYANO',
    },
    {
      name: 'Thabiso Matsaba',
      role: 'Technical Director',
      imageSrc: thabisoImage,
      imageHint: 'Photo of Thabiso Matsaba, Technical Director for KALYANO',
    },
  ];
  ...
  return (
    <div id="about" className={`${styles.pageContainer} ${theme === 'dark' ? styles.dark : styles.light}`}>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.missionGrid}>
            <div className={styles.missionSection}>
              ...
              <p className={styles.missionText}>
                Our mission is to elevate DJ brands and help artists showcase their talent through visually stunning and professionally produced content that resonates with the AMAPIANO community.
              </p>
            </div>
            ...
            <div className={styles.amapianoCard}>
              ...
              <p className={styles.amapianoText}>
                AMAPIANO represents more than just music - it's a cultural movement that embodies creativity, community, and authentic expression. We're passionate about preserving and promoting this unique South African sound through compelling visual storytelling.
              </p>
            </div>
          </div>
