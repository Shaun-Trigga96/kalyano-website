...
const ContactSection = ({ theme }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!serviceID || !templateID || !publicKey) {
      const errorMsg = 'EmailJS credentials are not configured. Please check environment variables.';
    ...
    if (!form.current) {
      const errorMsg = 'Form reference is not available. Cannot send email.';
    ...
    const existingHidden = form.current.querySelectorAll('input[type="hidden"]');
    ...
    console.log('Form data state before sending:', formData);
    const formElementData = new FormData(form.current);
    console.log('Data constructed by new FormData(form.current):');
    for (let [key, value] of formElementData.entries()) {
    ...
    emailjs.sendForm(serviceID, templateID, form.current, publicKey)
      .then((result) => {
        ...
        console.log('Full EmailJS success response:', result);
        ...
        const errorMsg = `Oops! There was a problem sending your message. Error: ${error.text}`;
        setSubmitMessage(errorMsg);
        alert(errorMsg);
      })
      .finally(() => {
        console.log('EmailJS promise settled. Running finally block.');
        setIsSubmitting(false);
      });
    console.log('emailjs.sendForm call has been initiated.');
  };

  const handleWhatsAppClick = () => {
    const phoneNumber = '27676817119';
    window.open(`https://wa.me/${phoneNumber}`, '_blank');
  };

  const handleCallClick = () => {
    const phoneNumber = '0676817119';
  ...
  return (
    <>
      <div id="contact" className={`${styles.pageContainer} ${theme === 'dark' ? styles.dark : styles.light}`}>
        <div className={styles.container}>
          ...
          <div className={styles.contentGrid}>
              ...
              <div className={styles.infoItems}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div>
                    ...
                    <p className={styles.infoItemText}>capevisionsstudios@gmail.com</p>
                    <p className={styles.infoItemText}>thandosiloyi@gmail.com</p>
                  </div>
                </div>
            ...
            {/* Contact Form */}
            <form ref={form} onSubmit={handleSubmit} className={styles.formCard}>
              ...
              <div className={styles.formFields}>
                ...
                <div className={styles.formGroup}>
                  ...
                  >
                    ...
                    <option value="basic">Basic Video Mix (R1,400)</option>
                    <option value="standard">Standard Video Mix (R3,000)</option>
                    <option value="premium">Premium Video Mix (R6,000+)</option>
                    <option value="consultation">Basic Consultation (+R150)</option>
                ...
                {submitMessage && (
                  <p className={styles.submitStatusMessage}>
                    {submitMessage}
                  </p>
                )}
              </div>
          ...
          <div className={styles.quickContactSection}>
            ...
            <div className={styles.quickContactGrid}>
              <div className={styles.quickContactCard}>
                ...
                <button
                  className={`${styles.quickContactButton} ${styles.whatsappButton}`}
              ...
              <div className={styles.quickContactCard}>
                ...
                <button
                  className={`${styles.quickContactButton} ${styles.callButton}`}
              ...
              <div className={styles.quickContactCard}>
                ...
                <button
                  className={`${styles.quickContactButton} ${styles.bookButton}`}
            ...
            <div className={styles.mapCard}>
              ...
              <div className={styles.mapContent}>
                <div className={styles.mapContentInner}>
                  ...
                  <p className={styles.contentText} >Contact us to book a slot</p>
                  <p className={styles.contentNoteText}>Map integration available upon request</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className={styles.faqCard}>
              <div className={styles.faqItems}>
                ...
                <div className={styles.faqItem}>
                  ...
                  <p className={styles.faqAnswer}>Standard editing takes 5-7 business days. Rush delivery is available for an additional R500 and takes 2-3 business days.</p>
                </div>
      ...
      <BookingModal isOpen={isModalOpen} onClose={closeBookingModal} theme={theme} />
    </>
  );
};
